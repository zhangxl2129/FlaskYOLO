...
class ExplorerDataset(YOLODataset):
    ...
    def build_transforms(self, hyp: IterableSimpleNamespace = None):
        """Creates transforms for dataset imgs without resizing."""
        return Format(
            bbox_format="xyxy",
            normalize=False,
...
class Explorer:
    ...
    def create_embeddings_table(self, force: bool = False, split: str = "train") -> None:
        """
        Create LanceDB table containing the embeddings of the imgs in the dataset. The table will be reused if it
    ...
    def query(
        ...
        """
        Query the table for similar imgs. Accepts a single image or a list of imgs.

        Args:
            imgs (str or list): Path to the image or a list of paths to the imgs.
        ...
        # Get avg if multiple imgs are passed (len > 1)
    ...
    def get_similar(
        ...
        Args:
            img (str or list): Path to the image or a list of paths to the imgs.
    ...
    def plot_similar(
        ...
        """
        Plot the similar imgs. Accepts imgs or indexes.
    ...
    def similarity_index(self, max_dist: float = 0.2, top_k: float = None, force: bool = False) -> Any:  # pd.DataFrame
        """
        Calculate the similarity index of all the imgs in the table. Here, the index will contain the data points that
        ...
        Returns:
            (pandas.DataFrame): A dataframe containing the similarity index. Each row corresponds to an image,
                and columns include indices of similar imgs and their respective distances.
        ...
        def _yield_sim_idx():
            """Generates a dataframe with similarity indices and distances for imgs."""
    ...
    def plot_similarity_index(self, max_dist: float = 0.2, top_k: float = None, force: bool = False) -> Image:
        """
        Plot the similarity index of all the imgs in the table. Here, the index will contain the data points that are
    ...
    def _check_imgs_or_idxs(
        ...
        """Determines whether to fetch imgs or indexes based on provided arguments and returns image paths."""
    ...
    def ask_ai(self, query):
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            answer = exp.ask_ai("Show imgs with 1 person and 2 dogs")
            ```
        """
