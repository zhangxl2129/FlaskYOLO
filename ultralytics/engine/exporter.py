...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if any(f):
            ...
            s = (
                ""
                if square
                else f"WARNING ⚠️ non-PyTorch val requires square imgs, 'imgsz={self.imgsz}' will not "
    ...
    def get_int8_calibration_dataloader(self, prefix=""):
        ...
        LOGGER.info(f"{prefix} collecting INT8 calibration imgs from 'data={self.args.data}'")
        ...
        n = len(dataset)
        if n < 300:
            LOGGER.warning(f"{prefix} WARNING ⚠️ >300 imgs recommended for INT8 calibration, found {n} imgs.")
    ...
    def export_onnx(self, prefix=colorstr("ONNX:")):
        ...
        if dynamic:
            dynamic = {"imgs": {0: "batch", 2: "height", 3: "width"}}  # shape(1,3,640,640)
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        np_data = None
        if self.args.int8:
            tmp_file = f / "tmp_tflite_int8_calibration_images.npy"  # int8 calibration imgs file
            verbosity = "info"
            if self.args.data:
                f.mkdir()
                ...
                np_data = [["imgs", tmp_file, [[[[0, 0, 0]]]], [[[[255, 255, 255]]]]]]
        else:
            verbosity = "error"
