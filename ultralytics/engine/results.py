...
class Results(SimpleClass):
    ...
    Methods:
        ...
        save_crop: Saves cropped detection imgs.
    ...
    def save_crop(self, save_dir, file_name=Path("im.jpg")):
        """
        Saves cropped detection imgs to specified directory.

        This method saves cropped imgs of detected objects to a specified directory. Each crop is saved in a
        subdirectory named after the object's class, with the filename based on the input file_name.

        Args:
            save_dir (str | Path): Directory path where cropped imgs will be saved.
            file_name (str | Path): Base filename for the saved cropped imgs. Default is Path("im.jpg").
