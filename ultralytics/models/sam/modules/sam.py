...
class SAMModel(nn.Module):
    ...
    This class combines image encoders, prompt encoders, and mask decoders to predict object masks from imgs
    and input prompts.

    Attributes:
        mask_threshold (float): Threshold value for mask prediction.
        image_encoder (ImageEncoderViT): Backbone for encoding imgs into embeddings.
...
class SAM2Model(torch.nn.Module):
    ...
    Attributes:
        ...
        image_size (int): Size of input imgs.
    ...
    def _prepare_memory_conditioned_features(
        ...
        # The case of `self.num_maskmem == 0` below is primarily used for reproducing SAM on imgs.
    ...
    def track_step(
        ...
        # settings like SAM training on static imgs, we don't need the memory encoder.
