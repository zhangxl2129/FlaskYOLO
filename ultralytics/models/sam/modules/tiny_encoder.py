...
class PatchEmbed(nn.Module):
    """
    Embeds imgs into patches and projects them into a specified embedding dimension.
    ...
    def forward(self, x):
        """Processes input tensor through patch embedding sequence, converting imgs to patch embeddings."""
        return self.seq(x)
