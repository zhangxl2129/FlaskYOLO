...
class Predictor(BasePredictor):
    ...
    Methods:
        preprocess: Prepares input imgs for model inference.
    ...
    def postprocess(self, preds, img, orig_imgs):
        ...
        Args:
            ...
            orig_imgs (List[np.ndarray] | torch.Tensor): The original, unprocessed imgs.
        ...
        if not isinstance(orig_imgs, list):  # input imgs are a torch.Tensor, not a list
    ...
    def setup_source(self, source):
        ...
        This method configures the data source from which imgs will be fetched for inference. It supports
        ...
        Examples:
            >>> predictor = Predictor()
            >>> predictor.setup_source("path/to/imgs")
...
class SAM2Predictor(Predictor):
    ...
    def prompt_inference(
        ...
        This method leverages the Segment Anything Model 2 (SAM2) to generate segmentation masks for input imgs
    ...
    def set_image(self, image):
        ...
        Notes:
            ...
            - Only one image can be set at a time. To process multiple imgs, call this method for each new image.
        """
        if self.model is None:
            self.setup_model(model=None)
        self.setup_source(image)
