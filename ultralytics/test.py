...
if __name__ == '__main__':
    ...
    best_model = 'runs/detect/train2/weights/gangcai.pt'  # Change to your model path 18
    ...
    for img_path in image_files:
        ...
        # Predict using YOLO
        results = model.predict(source=img_path, save=False)  # Do not save predicted imgs
