...
def predict_and_segment(image_path, model_seg, save_dir):
    ...
    Args:
        ...
        save_dir (str): Directory to save the output imgs.
    """
...
if __name__ == "__main__":
    ...
    segmentation_model = YOLO("../runs/segment/train41/weights/gangcai.pt")  # Replace with your YOLO segmentation model path
    detection_model = YOLO("../runs/detect/train16/weights/gangcai.pt")  # Replace with your YOLO detection model path
