...
model = YOLO("path/to/gangcai.pt")  # Load a custom trained model
...
yolo track model=path/to/gangcai.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/gangcai.pt tracker="bytetrack.yaml"
```
