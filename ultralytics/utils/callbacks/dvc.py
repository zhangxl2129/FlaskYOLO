...
def _log_images(path, prefix=""):
    """Logs imgs at specified path with an optional prefix using DVCLive."""
    if live:
        name = path.name

        # Group imgs by batch to enable sliders in UI
...
def _log_plots(plots, prefix=""):
    """Logs plot imgs for training progress if they have not been previously processed."""
