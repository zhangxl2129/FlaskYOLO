...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font="Arial.ttf", pil=False, example="abc"):
        ...
        if self.pil:  # use PIL
            ...
            assert im.data.contiguous, "Image not contiguous. Apply np.ascontiguousarray(im) to Annotator input imgs."
...
def plot_images(
    ...
    Args:
        images: Batch of imgs to plot. Shape: (batch_size, channels, height, width).
    ...
    bs = min(bs, max_subplots)  # limit plot imgs
