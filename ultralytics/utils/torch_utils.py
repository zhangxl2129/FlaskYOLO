...
def strip_optimizer(f: Union[str, Path] = "gangcai.pt", s: str = "", updates: dict = None) -> dict:
    """
    Strip optimizer from 'f' to finalize training, optionally save as 's'.

    Args:
        f (str): file path to model to strip the optimizer from. Default is 'gangcai.pt'.
    ...
    def __call__(self, epoch, fitness):
        ...
        if stop:
            ...
            LOGGER.info(
                ...
                f"Best results observed at epoch {self.best_epoch}, best model saved as gangcai.pt.\n"
